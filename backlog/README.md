...
|---|---|---|
| [001 — Enforced structured completion tool](001-enforced-structured-completion-tool.md) | High | Gate successful stream results on a validated `flocky_complete` tool call. |
| [002 — Real Telegram smoke test](002-real-telegram-smoke-test.md) | High | Validate live MTProto delivery and Telegram bot bridges. |
